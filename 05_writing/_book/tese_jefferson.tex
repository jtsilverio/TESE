...
\begin{document}
  ...
  {\centering \includegraphics[width=0.88\linewidth]{tese_jefferson_files/figure-latex/plot-patterns-1} 
  ...
  {\centering \includegraphics[width=0.95\linewidth]{tese_jefferson_files/figure-latex/diurnality-plot-1} 
  ...
  {\centering \includegraphics{tese_jefferson_files/figure-latex/rhymicity-bars-1} 
