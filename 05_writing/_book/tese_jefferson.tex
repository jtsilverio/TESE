...
\begin{document}
  ...
  {\centering \includegraphics{tese_jefferson_files/figure-latex/hmm-1} 
  ...
  {\centering \includegraphics[width=0.9\linewidth]{tese_jefferson_files/figure-latex/plot-patterns-1} 
  ...
  \begin{center}\includegraphics[width=1\linewidth]{tese_jefferson_files/figure-latex/timeseries-1} \end{center}
  ...
  {\centering \includegraphics[width=1\linewidth]{tese_jefferson_files/figure-latex/hist-1} 
  ...
  {\centering \includegraphics[width=1\linewidth]{tese_jefferson_files/figure-latex/boxplot-1} 
  ...
  \begin{center}\includegraphics[width=1\linewidth]{tese_jefferson_files/figure-latex/graph-hourly-id-1} \end{center}
  ...
  \begin{center}\includegraphics[width=1\linewidth]{tese_jefferson_files/figure-latex/density-season-sex-1} \end{center}
  ...
  \end{tabular}
  \end{table}
  \begin{center}\includegraphics[width=1\linewidth]{tese_jefferson_files/figure-latex/boxplot-season-sex-1} \end{center}

  \hypertarget{ecdf}{%
  \section{ECDF}\label{ecdf}}
  \begin{center}\includegraphics[width=1\linewidth]{tese_jefferson_files/figure-latex/unnamed-chunk-4-1} \end{center}
  ...
  \begin{center}\includegraphics[width=1\linewidth]{tese_jefferson_files/figure-latex/graph-hourly-season-1} \end{center}
