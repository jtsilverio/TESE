...
```{r plot-ri-and-period, fig.width=7, fig.height=6, fig.pos = "H", out.width="100%", fig.align='center', fig.cap = "Distribution of Rhythmicity Index for state-labelled data and VeDBA. The distribution of the Medium State is statistically different from all other states and VeDBA. Graphs shows half boxplots and individual data"}
