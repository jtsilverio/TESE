...
# Changes in daily activity patterns throughout the year in free-living tuco-tucos (_Ctenomys_ aff _knighti_)
...
Surface emergence shows a changing daily temporal pattern along the year. In July, the peak of surface emergence is concentrated in the middle of the day. In other months the peak of surface emergence shifts to the first hours of daylight (Figure \@ref(fig:plot-light-exposure)A).
