...
english: false
title: 'Mudanças nos padrões diários de atividade ao longo do ano em tuco-tucos de vida livre (_Ctenomys_ aff. _knighti_)'
foreigntitle: 'Changes in daily activity patterns throughout the year in free-living tuco-tucos (_Ctenomys_ aff. _knighti_)'
...
keyword: [biologging, hidden markov models, chronobiology, subterranean rodent, activity patterns, diurnality, cronobiologia, roedor subterrâneo, padrões de atividade, diurnalidade]
author:
  - name: Jefferson T.
    surname: Silvério
advisor:
