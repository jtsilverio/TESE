...
weather.2017 = readxl::read_xlsx(
    path = "01_data/weather/2017 - 04JAN-31DEZ.xlsx",
    col_names = TRUE,
    na = "---",
    col_types = "guess"
)
...
weather.2019 = readxl::read_xlsx(
    path = "01_data/weather/2019 - 01JAN-31DEZ.xlsx",
    col_names = TRUE,
    na = "---",
    col_types = "guess"
)
...
ggsave("04_figures/appendix/plot_weather.png", climograph, "png", width = 9, height = 10)
