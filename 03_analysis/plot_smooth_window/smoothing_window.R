...
tuco = readRDS("01_data/activity_processed/tuco_10hz_smooth_subset.rds") # This is a subset of 4 animal/4 days
...
ggsave("04_figures/appendix/plot_smoothing_window.png", plot_smoothwindow, "png", width = 9, height = 10)
